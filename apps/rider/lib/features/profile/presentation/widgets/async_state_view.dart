...
///
/// Reused by both the Profile screen (profile fetch) and the Notification
/// Center (notification list fetch) so the four required UI states are
/// implemented once, consistently, with one smooth cross-fade between them
/// — not re-built ad hoc per screen.
