...
/// "Driver Assigned" — a driver has been matched and is heading to pickup.
class DriverAssignedView extends StatelessWidget {
  const DriverAssignedView({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const TripStatusBanner(status: RiderTripStatus.driverAssigned),
        const SizedBox(height: 16),
        const TripProgressIndicator(status: RiderTripStatus.driverAssigned),
        const SizedBox(height: 16),
