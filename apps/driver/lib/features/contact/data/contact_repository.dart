...
/// anytime a driver is assigned to a trip — it only ever returns
/// [ContactInfo.maskedPhone] for display. `call` is the one place a real
/// phone number ever leaves the backend, and only so the caller can
/// immediately hand it to `url_launcher`'s `tel:` scheme — never render it,
/// never persist it.
