...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _verifyOtp() async {
    ...
    try {
      ...
      // Reset before login() so a stale approved value from a previous
      // session/account never survives into this one — the redirect only
      // recomputes once both notifyListeners() calls have fired, and this
      // ordering guarantees Splash re-runs KycGate.refresh from scratch.
