...
/// This app's own side of every conversation — a Driver never renders a
/// bubble as "mine" unless the message's sender_role is exactly this.
const String _mySenderRole = 'driver';
...
class _ChatPageState extends State<ChatPage> with WidgetsBindingObserver {
  ...
  Future<void> _pollNext() async {
    ...
    try {
      ...
      // A single failed poll cycle is not shown to the driver — the loop
