/// Icon size scale. Pick the size that matches the icon's role, not its
/// visual container — e.g. an icon inside a 52px avatar circle is still
/// [lg] (24), the circle's own size is a spacing/radius concern, not an
/// icon-size one.
