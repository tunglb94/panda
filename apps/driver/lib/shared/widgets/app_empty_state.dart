...
/// and "not built yet" (placeholder tab) states. Consolidates what were
/// three near-identical implementations: `PlaceholderTabContent`,
/// `AsyncStateView`'s default empty/error builders, and `TripPage`'s private
/// `_ErrorView`.
///
...
/// empty states called out in `docs/design/MASCOT_CATALOG.md` — left unset,
/// every other empty/error state keeps its plain icon exactly as before,
/// per the "don't stuff a mascot everywhere" design rule.
