...
/// Standard snackbar — icon + accent color per [AppSnackbarType], all
/// resolving back to the Panda green brand family for the neutral/success
/// path rather than a generic Material gray. Replaces bare
/// `ScaffoldMessenger.of(context).showSnackBar(const SnackBar(...))` calls
/// with one call that also picks the right icon/accent for the message.
