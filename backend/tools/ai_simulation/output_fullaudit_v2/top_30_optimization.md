...
## 1. Ưu tiên phân bổ tài xế và khuyến mãi mục tiêu tại Trung tâm (CBD) — khu vực có nhu cầu cao nhất (112644 yêu cầu).

- **Priority:** Medium
- **Expected Impact:** Tối đa hoá GMV tại khu vực có nhu cầu cao nhất
- **Risk:** Có thể gây mất cân bằng phân bổ tài xế ở khu vực khác

## 2. Điều tra nguyên nhân vận hành tại Trung tâm (CBD) — khu vực có số chuyến huỷ sau khi đã ghép tài xế cao nhất (189 chuyến).

- **Priority:** High
- **Expected Impact:** Giảm cancellation rate
- **Risk:** Cần điều tra vận hành cụ thể trước khi hành động

## 3. Tăng incentive/thưởng theo giờ cho tài xế hoạt động tại Sân bay — tỉ lệ cầu/cung trung bình đang ở mức 45.2x.

- **Priority:** High
- **Expected Impact:** Giảm ETA và tăng acceptance rate tại khu vực thiếu cung
- **Risk:** Chi phí incentive tăng ngắn hạn

## 4. Mở rộng ngân sách cho "Manual Coupon" — ROI cao nhất (9.1x), 1457 lượt redeem.

- **Priority:** Medium
- **Expected Impact:** Tăng GMV và số chuyến với chi phí khuyến mãi hiệu quả
- **Risk:** Ngân sách marketing tăng

## 5. Tăng mật độ tài xế tại các khu vực/khung giờ có ETA cao — ETA trung bình hiện tại 34.2 phút.

- **Priority:** Medium
- **Expected Impact:** Giảm ETA trung bình, tăng trải nghiệm khách hàng
- **Risk:** Cần tăng mật độ tài xế, có thể tăng chi phí incentive

## 6. Xem xét giảm ngân sách hoặc thắt chặt điều kiện áp dụng cho "First Ride" — ROI thấp nhất trong các chương trình đã redeem (1.4x).
...
## 9. Tối ưu vùng phủ tài xế cho Delivery — thời gian lấy hàng trung bình hiện tại 27.7 phút.

- **Priority:** Medium
- **Expected Impact:** Giảm thời gian lấy hàng cho Delivery
- **Risk:** Cần thêm tài xế chuyên trách Delivery ở khu vực nguồn hàng

## 10. Khuyến khích tài xế online sớm trước khung giờ 04:00 (surge trung bình 1.36x) bằng thưởng cố định thay vì để khách chịu surge toàn bộ.
...
## 12. Theo dõi biến động GMV theo Ride (25,443,818,835 VND) và Delivery (9,049,865,304 VND) theo thời gian thực để phát hiện tính mùa vụ sớm.
