...
Phát hành: **50**, đã dùng: **21** → **58.0%** voucher chưa từng được redeem trong lần chạy này.

## 5. Promotion ROI

- **manual_coupon**: ROI 9.48x, CPA 7,468 VND/lượt, 12 lượt redeem, repeat rate 83.3%
...
|---|---:|---:|---:|---:|
| Sân bay | 103 | 33.0% | 38.4 phút | 2.33x |
| Bến xe | 89 | 74.2% | 35.7 phút | 2.59x |
| Trung tâm (CBD) | 102 | 92.2% | 26.4 phút | 3.03x |
| Khu vui chơi | 102 | 85.3% | 32.9 phút | 2.40x |
| Bệnh viện | 72 | 84.7% | 27.8 phút | 5.50x |
| Khu công nghiệp (KCN) | 93 | 53.8% | 40.1 phút | 1.78x |
| Khu dân cư | 111 | 62.2% | 35.3 phút | 1.37x |
| Trường học | 71 | 84.5% | 29.6 phút | 2.59x |

## 12. ETA cao nhất

Khu vực **Khu công nghiệp (KCN)** có ETA trung bình cao nhất: **40.1 phút**.

## 13. Khu vực thiếu driver

- Bệnh viện: cầu/cung trung bình **5.5x**
- Trung tâm (CBD): cầu/cung trung bình **3.0x**
- Bến xe: cầu/cung trung bình **2.6x**

## 14. Khu vực thừa driver

- Khu dân cư: cầu/cung trung bình **1.37x**
- Khu công nghiệp (KCN): cầu/cung trung bình **1.78x**
- Sân bay: cầu/cung trung bình **2.33x**

## 15. Ride vs Delivery Ratio

Ride: **443**, Delivery: **78** → tỉ lệ **5.68:1**.

## 16. Airport Profit

71 chuyến liên quan Sân bay, lợi nhuận trung bình/chuyến **19,084 VND**, tổng **1,355,026 VND**.

## 17. Peak Hour Profit

142 chuyến giờ cao điểm (07:00-09:00, 17:00-20:00), lợi nhuận trung bình/chuyến **11,039 VND**.

## 18. Off Peak Profit

379 chuyến giờ thấp điểm, lợi nhuận trung bình/chuyến **10,733 VND**.

## 19. Weather ảnh hưởng thế nào

- **heavy_rain**: 251 chuyến, fare TB 66,001 VND, surge TB 1.27x, cancel rate 1.1%
- **light_rain**: 270 chuyến, fare TB 61,862 VND, surge TB 1.28x, cancel rate 0.0%
