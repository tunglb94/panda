...
_Lưu ý: chỉ 11 đề xuất đủ điều kiện nổi bật trong lần chạy này (ngưỡng tối đa là 30)._

## 1. Tăng incentive/thưởng theo giờ cho tài xế hoạt động tại Bệnh viện — tỉ lệ cầu/cung trung bình đang ở mức 9.4x.

- **Priority:** High
- **Expected Impact:** Giảm ETA và tăng acceptance rate tại khu vực thiếu cung
- **Risk:** Chi phí incentive tăng ngắn hạn

## 2. Mở rộng ngân sách cho "Manual Coupon" — ROI cao nhất (9.0x), 13 lượt redeem.

- **Priority:** Medium
- **Expected Impact:** Tăng GMV và số chuyến với chi phí khuyến mãi hiệu quả
- **Risk:** Ngân sách marketing tăng

## 3. Xem xét lộ trình lên hạng (tier) rõ ràng hơn cho tài xế mới — 60.0% tài xế vẫn ở hạng Bronze (hoa hồng 20%, cao nhất theo BRB §7.1).
...
## 4. Tăng mật độ tài xế tại các khu vực/khung giờ có ETA cao — ETA trung bình hiện tại 29.0 phút.

- **Priority:** Medium
- **Expected Impact:** Giảm ETA trung bình, tăng trải nghiệm khách hàng
- **Risk:** Cần tăng mật độ tài xế, có thể tăng chi phí incentive

## 5. Ưu tiên phân bổ tài xế và khuyến mãi mục tiêu tại Trung tâm (CBD) — khu vực có nhu cầu cao nhất (99 yêu cầu).

- **Priority:** Medium
- **Expected Impact:** Tối đa hoá GMV tại khu vực có nhu cầu cao nhất
- **Risk:** Có thể gây mất cân bằng phân bổ tài xế ở khu vực khác

## 6. Thiết kế ưu đãi nâng hạng thành viên — 75.0% khách hàng vẫn ở hạng Free.
...
## 7. Đơn giản hoá điều kiện áp dụng voucher — chỉ 19.2% lượt được đề nghị chọn dùng ngay.

- **Priority:** Low
- **Expected Impact:** Tăng tỉ lệ redeem voucher đã phát hành
- **Risk:** Chi phí voucher có thể tăng nếu quá dễ áp dụng

## 8. Khuyến khích tài xế online sớm trước khung giờ 23:00 (surge trung bình 1.33x) bằng thưởng cố định thay vì để khách chịu surge toàn bộ.
...
## 9. Rà soát cấu trúc giá cho hạng "Bike" — lợi nhuận trung bình/chuyến thấp hơn đáng kể so với "Car XL".

- **Priority:** Low
- **Expected Impact:** Cải thiện lợi nhuận ở hạng xe yếu nhất
- **Risk:** Cần phân tích thêm nguyên nhân chênh lệch trước khi đổi giá

## 10. Theo dõi biến động GMV theo Ride (22,161,301 VND) và Delivery (6,494,413 VND) theo thời gian thực để phát hiện tính mùa vụ sớm.

- **Priority:** Low
- **Expected Impact:** Theo dõi tính mùa vụ để tối ưu phân bổ ngân sách marketing
- **Risk:** Không có

## 11. Điều tra nguyên nhân vận hành tại Khu dân cư — khu vực có số chuyến huỷ sau khi đã ghép tài xế cao nhất (1 chuyến).
