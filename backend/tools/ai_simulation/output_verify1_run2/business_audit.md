...
Phát hành: **110**, đã dùng: **63** → **42.7%** voucher chưa từng được redeem trong lần chạy này.

## 5. Promotion ROI

- **manual_coupon**: ROI 9.00x, CPA 4,942 VND/lượt, 32 lượt redeem, repeat rate 59.4%
- **first_ride**: ROI 2.30x, CPA 24,127 VND/lượt, 2 lượt redeem, repeat rate 50.0%
...
**2** tài xế có thu nhập/tuần vượt ngưỡng thống kê (mean + 3×độ lệch chuẩn).
...
|---|---:|---:|---:|---:|
| Sân bay | 128 | 47.7% | 40.4 phút | 0.90x |
| Bến xe | 182 | 64.3% | 35.0 phút | 2.45x |
| Trung tâm (CBD) | 244 | 68.0% | 22.6 phút | 6.22x |
| Khu vui chơi | 204 | 61.8% | 32.3 phút | 2.96x |
| Bệnh viện | 148 | 74.3% | 27.1 phút | 8.61x |
| Khu công nghiệp (KCN) | 193 | 55.4% | 41.8 phút | 2.37x |
| Khu dân cư | 214 | 59.8% | 32.1 phút | 2.37x |
| Trường học | 220 | 59.5% | 24.6 phút | 4.66x |

## 12. ETA cao nhất

Khu vực **Khu công nghiệp (KCN)** có ETA trung bình cao nhất: **41.8 phút**.

## 13. Khu vực thiếu driver

- Bệnh viện: cầu/cung trung bình **8.6x**
- Trung tâm (CBD): cầu/cung trung bình **6.2x**
- Trường học: cầu/cung trung bình **4.7x**

## 14. Khu vực thừa driver

- Sân bay: cầu/cung trung bình **0.90x**
- Khu công nghiệp (KCN): cầu/cung trung bình **2.37x**
- Khu dân cư: cầu/cung trung bình **2.37x**

## 15. Ride vs Delivery Ratio

Ride: **723**, Delivery: **223** → tỉ lệ **3.24:1**.

## 16. Airport Profit

129 chuyến liên quan Sân bay, lợi nhuận trung bình/chuyến **16,851 VND**, tổng **2,173,827 VND**.

## 17. Peak Hour Profit

301 chuyến giờ cao điểm (07:00-09:00, 17:00-20:00), lợi nhuận trung bình/chuyến **9,421 VND**.

## 18. Off Peak Profit

645 chuyến giờ thấp điểm, lợi nhuận trung bình/chuyến **9,476 VND**.

## 19. Weather ảnh hưởng thế nào

- **sunny**: 946 chuyến, fare TB 54,965 VND, surge TB 1.11x, cancel rate 25.3%
