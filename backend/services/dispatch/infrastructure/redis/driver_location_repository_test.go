...
func TestUpdateLocation_StoresAndActive(t *testing.T) {
	...
	if err := repo.UpdateLocation(ctx, "d1", 10.762, 106.660); err != nil {
...
func TestFindNearby_ReturnsSorted(t *testing.T) {
	...
	_ = repo.UpdateLocation(ctx, "d_near", 10.762, 106.660)   // ~0 km from search point
	_ = repo.UpdateLocation(ctx, "d_far", 10.800, 106.710)    // ~6 km away
	_ = repo.UpdateLocation(ctx, "d_farther", 10.900, 106.800) // ~18 km away
...
func TestIsActive_FalseAfterTTLExpiry(t *testing.T) {
	...
	_ = repo.UpdateLocation(ctx, "d_ttl", 10.0, 106.0)
...
func TestRemoveLocation(t *testing.T) {
	...
	_ = repo.UpdateLocation(ctx, "d1", 10.0, 106.0)
